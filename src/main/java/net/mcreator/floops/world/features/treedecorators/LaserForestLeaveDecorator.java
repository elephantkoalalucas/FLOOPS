...
package net.mcreator.floops.world.features.treedecorators;
...
public class LaserForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<LaserForestLeaveDecorator> CODEC = MapCodec.unit(LaserForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("floops:laser_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public LaserForestLeaveDecorator() {
		super(0.25f);
	}
