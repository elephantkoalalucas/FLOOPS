...
public class LaserForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<LaserForestTrunkDecorator> CODEC = MapCodec.unit(LaserForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("floops:laser_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
